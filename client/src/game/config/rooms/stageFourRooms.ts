...
export const INFERNO_ROOM_ONE = defineRoom({
  ...
  enemySpawns: [
    ...
    { type: 'flying', x: 1050, y: GAME_HEIGHT - 310 },
    { type: 'ranged', x: 1400, y: GAME_HEIGHT - 120 },
    { type: 'melee', x: 1900, y: GAME_HEIGHT - 120 },
    { type: 'flying', x: 2350, y: GAME_HEIGHT - 300 },
    { type: 'ranged', x: 2700, y: GAME_HEIGHT - 120 },
    { type: 'melee', x: 3200, y: GAME_HEIGHT - 120 },
    { type: 'ranged', x: 3700, y: GAME_HEIGHT - 120 },
    { type: 'flying', x: 4100, y: GAME_HEIGHT - 290 },
  ],
  terrain: [
    { type: 'platform', x: 900, y: LOW_LEDGE_Y, width: 220, height: 22 },
    { type: 'platform', x: 2250, y: LOW_LEDGE_Y, width: 220, height: 22 },
    { type: 'platform', x: 3350, y: LOW_LEDGE_Y, width: 220, height: 22 },
    { type: 'platform', x: 3420, y: MID_LEDGE_Y, width: 180, height: 22 },
  ],
  pits: [
    { x: 1500, width: 180 },
    { x: 2800, width: 200 },
...
export const INFERNO_ROOM_TWO = defineRoom({
  ...
  intensity: 1.55,
  enemySpawns: [
    { type: 'flying', x: 1050, y: GAME_HEIGHT - 320 },
    { type: 'ranged', x: 1400, y: GAME_HEIGHT - 120 },
    { type: 'melee', x: 1900, y: GAME_HEIGHT - 120 },
    // 중앙 균열에서는 높이 셋을 빠르게 바꾸며 위·아래 탄환 차단을 선택함.
    { type: 'flying', x: 2250, y: GAME_HEIGHT - 410 },
    { type: 'ranged', x: 2600, y: GAME_HEIGHT - 120 },
    { type: 'melee', x: 3150, y: GAME_HEIGHT - 120 },
    { type: 'flying', x: 3450, y: GAME_HEIGHT - 300 },
    { type: 'melee', x: 3750, y: GAME_HEIGHT - 120 },
    { type: 'ranged', x: 3900, y: GAME_HEIGHT - 120 },
    { type: 'flying', x: 4100, y: GAME_HEIGHT - 280 },
  ],
  terrain: [
    { type: 'platform', x: 1000, y: LOW_LEDGE_Y, width: 220, height: 22 },
    { type: 'platform', x: 2100, y: LOW_LEDGE_Y, width: 200, height: 22 },
    { type: 'platform', x: 3300, y: LOW_LEDGE_Y, width: 220, height: 22 },
    { type: 'platform', x: 1080, y: MID_LEDGE_Y, width: 180, height: 22 },
    { type: 'platform', x: 2160, y: MID_LEDGE_Y, width: 180, height: 22 },
    { type: 'platform', x: 3380, y: MID_LEDGE_Y, width: 190, height: 22 },
    { type: 'platform', x: 2220, y: HIGH_LEDGE_Y, width: 160, height: 22 },
  ],
  pits: [
    { x: 1600, width: 160 },
    { x: 2850, width: 190 },
